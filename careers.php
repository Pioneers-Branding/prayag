...
<body>
    ...
    <main>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-4 mb-lg-0">
                        <img src="https://images.unsplash.com/photo-1551884170-09fb70a3a2ed?w=800&q=80"
                            alt="Medical Team" class="img-fluid rounded shadow-lg">
                    </div>
                    <div class="col-lg-6 ps-lg-5">
                        <h2 class="mb-4" style="font-weight: 700;">Work with Purpose</h2>
                        <p class="lead text-muted mb-4">At Prayag Hospital, we don't just treat patients; we care for
                            lives. Join a team that values compassion, excellence, and innovation.</p>
                        <p>We believe that our employees are our greatest asset. We foster an environment of continuous
                            learning, professional growth, and mutual respect. whether you are a doctor, nurse,
                            technician, or support staff, your contribution matters in our mission to heal.</p>
                        <div class="row mt-4">
                            <div class="col-md-6 mb-3">
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> Professional
                                        Growth</li>
                                    <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> Advanced
                                        Technology</li>
                                </ul>
                            </div>
                            <div class="col-md-6">
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> Supportive
                                        Environment</li>
        ...
        <section class="openings-section py-5 bg-white">
            <div class="container">
                <div class="section-header text-center mb-5">
                    <h2 style="font-weight: 700;">Current Openings</h2>
        ...
        <section class="application-form-section" id="applicationForm">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="card border-0 shadow-sm">
                            <div class="card-body p-5">
                                <h3 class="text-center mb-4" style="font-weight: 700;">Apply Now</h3>
                                <p class="text-center text-muted mb-4">Fill out the form below and our HR team will get
                                    back to you.</p>

                                <form accept-charset='UTF-8'
                                    action='https://app.formester.com/forms/D4vYnLrZT/submissions' method='POST'
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="form-text">PDF or Docx format only.</div>
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Message (Optional)</label>
                                            <textarea class="form-control" name="message" rows="4"
                                                placeholder="Briefly tell us about yourself..."></textarea>
                                        </div>
                                        <div class="col-12 text-center mt-4">
                                            <button type="submit" class="btn btn-primary px-5 py-2 rounded-pill"
                                                style="background-color: var(--prayag-teal); border: none;">Submit
                                                Application</button>
                                        </div>
                                    </div>
                                </form>
