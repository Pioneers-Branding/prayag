...
$doctor_id = 'dr-manju-sinha'; // ID in doctors-data.php
...
<head>
    ...
    <title>Dr. Manju Sinha – Gynaecologist in Noida | Prayag Hospital</title>
    <meta name="description" content="Consult Dr. Manju Sinha, Gynaecologist at Prayag Hospital, Noida with 45 years' experience. Book an appointment online or call 0120-4021900.">
    ...
    <script type="application/ld+json">
{
    ...
    "url": "https://prayaghospital.in/dr-manju-sinha.php",
    "worksFor": {
        "@type": "Hospital",
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="doctor-profile-header">
                        ...
                        <p class="lead-text">
                            Dr. Manju Sinha is a highly experienced Sr. Consultant Gynecologist and Obstetrician, known for excellence in women's healthcare across all stages of life.
                        </p>
                        <p>
