...
<body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-12">
                        ...
                        <p class="hero-subtitle" style="color:#000 !important">
                            ...
                            Radiofrequency Ablation (RFA), and Pacemaker Implantations to restore your heart's natural rhythm.
                        </p>
                        ...
                        <div class="hero-stats">
                            <div class="hero-stat-item">
                                <strong>Advanced EP Lab</strong>
                                3D Mapping System for precise ablation.
                            </div>
                            <div class="hero-stat-item">
                                <strong>Expert Care</strong>
                                Dedicated Electrophysiologists.
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="feature-box">
                        ...
                        <div class="feature-content">
                            <h3 class="feature-title">EPS & RFA</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="feature-box">
                        ...
                        <div class="feature-content">
                            <h3 class="feature-title">Pacemakers</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="feature-box">
                        ...
                        <div class="feature-content">
                            <h3 class="feature-title">ICD & CRT</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="feature-box">
                        ...
                        <div class="feature-content">
                            <h3 class="feature-title">Device Clinic</h3>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="overview-section" id="overview">
        <div class="container">
            <div class="overview-content">
                <h2 class="overview-heading">Normalizing Your Heart's Rhythm</h2>
                <p class="overview-text">
                    An arrhythmia is an irregularity in the heart's rhythm. It can mean the heart beats too fast, too slow, or with an irregular pattern. 
                    While some arrhythmias are harmless, others can be life-threatening and require immediate medical attention.
                </p>
                <p class="overview-text">
                    Prayag Hospital is equipped with a dedicated Electrophysiology (EP) department. Our team of specialized electrophysiologists uses 
                    advanced mapping systems to pinpoint the source of irregular heartbeats and treat them with high precision.
                </p>
                <p class="overview-text">
                    From managing palpitations with medication to implanting life-saving devices like Pacemakers and ICDs, we offer a comprehensive 
                    spectrum of care for all heart rhythm disorders.
                </p>
            </div>
            ...
            <div class="overview-highlights">
                <div class="overview-highlight">
                    ...
                    <h4>Precision Diagnosis</h4>
                    <p>EPS (Electrophysiology Study) to accurately diagnose the type and origin of arrhythmia.</p>
                </div>
                <div class="overview-highlight">
                    <i class="fas fa-burn"></i>
                    <h4>Curative Ablation</h4>
                    <p>Radiofrequency Ablation (RFA) to permanently cure many types of tachycardias.</p>
                </div>
                <div class="overview-highlight">
                    <i class="fas fa-heart"></i>
                    <h4>Heart Failure Care</h4>
                    <p>CRT-D implantation for patients with weak hearts and rhythm issues.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="conditions-section" id="conditions">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title">Common Rhythm Disorders</h2>
            ...
            <div class="row g-3">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="condition-card">
                        <h3 class="condition-name">Atrial Fibrillation (AFib)</h3>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="condition-card">
                        <h3 class="condition-name">Bradycardia (Slow Heartbeat)</h3>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="condition-card">
                        <h3 class="condition-name">Tachycardia (Fast Heartbeat)</h3>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="condition-card">
                        <h3 class="condition-name">Heart Block</h3>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="condition-card">
                        <h3 class="condition-name">SVT (Supraventricular Tachycardia)</h3>
                    </div>
                </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="treatment-card">
                        ...
                        <h3 class="treatment-card-title">Electrophysiology Study (EPS)</h3>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="treatment-card">
                        ...
                        <h3 class="treatment-card-title">Radiofrequency Ablation (RFA)</h3>
                        <p class="treatment-card-description">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="treatment-card">
                        ...
                        <h3 class="treatment-card-title">ICD Implantation</h3>
                        <p class="treatment-card-description">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="treatment-card">
                        ...
                        <h3 class="treatment-card-title">biventricular Pacing (CRT)</h3>
                        <p class="treatment-card-description">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="treatment-card">
                        ...
                        <h3 class="treatment-card-title">Remote Monitoring</h3>
                        <p class="treatment-card-description">
    ...
    <section class="why-choose-section" id="why-choose-us">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title">Why Prayag for Arrhythmia?</h2>
                <p class="section-subtitle">
            ...
            <div class="why-points-grid">
                ...
                <div class="why-point">
                    ...
                    <div class="why-point-content">
                        <h4>Specialized Experts</h4>
                        <p>Treatment by trained Electrophysiologists, specialists dedicated solely to heart rhythm disorders.</p>
                    </div>
                </div>
                ...
                <div class="why-point">
                    ...
                    <div class="why-point-content">
                        <h4>3D Mapping System</h4>
                        <p>Advance 3D Electro-anatomical mapping for precise localization and safe ablation of complex arrhythmias.</p>
                    </div>
                </div>
                ...
                <div class="why-point">
                    ...
                    <div class="why-point-content">
                        ...
                        <p>Proven track record of successful ablations and zero-infection protocols for device implantations.</p>
                    </div>
                </div>
                ...
                <div class="why-point">
                    ...
                    <div class="why-point-content">
                        ...
                        <p>Round-the-clock availability for managing sudden cardiac arrests and arrhythmia emergencies.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="testimonials-slider">
                        ...
                        <div class="testimonial-card" data-video-id="placeholder1">
                            ...
                            <div class="testimonial-overlay">
                                <p class="testimonial-text">"I used to faint frequently. After the pacemaker implantation, I have got a new lease of life. I feel safe now."</p>
                                <h4 class="testimonial-name">Ms. Sarita Sharma</h4>
                                <p class="testimonial-procedure">Pacemaker Implant</p>
                            </div>
                        </div>
                         ...
                         <div class="testimonial-card" data-video-id="placeholder2">
                            ...
                            <div class="testimonial-overlay">
                                <p class="testimonial-text">"The RFA procedure was magical. My palpitations are completely gone, and I don't need medicines anymore."</p>
                                <h4 class="testimonial-name">Mr. Rahul Varma</h4>
                                <p class="testimonial-procedure">RFA for SVT</p>
                            </div>
                        </div>
                    </div>
                </div>
