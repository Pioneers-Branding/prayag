                ...
                <div class="col-lg-5">
                    <div class="contact-details-wrapper">
                        ...
                        <div class="location-block mb-4">
                            <h3 class="location-title"><i class="fas fa-map-marker-alt text-primary-orange me-2"></i>
                                Noida</h3>
                        ...
                        <div class="contact-block mb-4">
                            <h3 class="location-title"><i class="fas fa-phone-alt text-primary-orange me-2"></i> Phone &
                                Fax</h3>
                            <p class="contact-text mb-1"><strong>Phone:</strong> <a href="tel:01204021900">0120 -
                                    4021900</a> | <a href="tel:01204021914">4021914</a></p>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="form-container">
                        ...
                        <p class="form-subtitle text-center">Have a question or need assistance? Fill out the form below
                            and our team will get back to you shortly.</p>

                        <script defer data-active data-widget-type="group"
                            data-person="5856289c-a991-42eb-b6e6-693a17e44e83"
