...
$doctor_id = 'dr-nrapendra-sharma'; // ID in doctors-data.php
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="doctor-profile-header">
                        ...
                        <p class="lead-text">
                            Dr. Nrapendra Sharma is a highly skilled and experienced Consultant Urologist, specializing in the diagnosis and treatment of urinary tract and male reproductive system disorders.
                        </p>
                        <p>
                            With strong clinical expertise and advanced surgical skills, he is proficient in managing both routine and complex urology cases using modern and minimally invasive techniques. Dr. Nrapendra is known for providing patient-focused care with accurate diagnosis, effective treatment planning, and excellent surgical outcomes.
                        </p>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="content-section">
                        ...
                        <div class="expertise-grid">
                            <div class="expertise-card">
                                ...
                                <h4>Kidney Stones</h4>
                                <p>Laser & Endoscopic Treatment</p>
                            </div>
                            <div class="expertise-card">
                                <i class="fas fa-male"></i>
                                <h4>Prostate Care</h4>
                                <p>BPH & Prostate Surgery</p>
                            </div>
                             <div class="expertise-card">
                    ...
                    <div class="content-section">
                        ...
                        <ul class="specialization-list">
                            <li><i class="fas fa-check-circle"></i> Kidney stone treatment (Laser & Endoscopic procedures)</li>
                            <li><i class="fas fa-check-circle"></i> Prostate disorders (BPH / Prostate enlargement)</li>
                            <li><i class="fas fa-check-circle"></i> Urinary tract infections (UTI) and bladder disorders</li>
                            <li><i class="fas fa-check-circle"></i> Uro-oncology (Kidney, bladder & prostate cancer management)</li>
                            <li><i class="fas fa-check-circle"></i> Male infertility and sexual health issues</li>
                            <li><i class="fas fa-check-circle"></i> Hydrocele, varicocele and scrotal surgeries</li>
                            <li><i class="fas fa-check-circle"></i> Urethral stricture management</li>
                            <li><i class="fas fa-check-circle"></i> Pediatric urology cases</li>
                            <li><i class="fas fa-check-circle"></i> Urinary incontinence and voiding dysfunction</li>
                            <li><i class="fas fa-check-circle"></i> Hematuria (blood in urine) evaluation and treatment</li>
                        </ul>
                    </div>
