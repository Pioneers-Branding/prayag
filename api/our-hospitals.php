            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="hospital-card">
                        <img src="../assets/images/prayag-hostipal-img.webp" alt="Prayag Hospital Noida"
                        ...
                        <div class="hospital-details">
                            ...
                            <div class="hospital-actions">
                                <a href="https://maps.app.goo.gl/UzFkbLXTXFfTaLAE8" target="_blank"
                                    class="btn btn-outline-teal flex-grow-1">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="hospital-card">
                        ...
                        <div class="hospital-details">
                            ...
                            <div class="hospital-actions">
                                <a href="https://maps.app.goo.gl/ZpgoC2Si63ecqSXh9" target="_blank"
                                    class="btn btn-outline-teal flex-grow-1">
                                    <i class="fas fa-location-arrow"></i> Directions
                                </a>
                                <a href="tel:01204021900" class="btn btn-primary-orange flex-grow-1">
