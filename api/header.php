    ...
    <div class="container">
        <div class="header-wrapper">
            ...
            <div class="logo-section d-flex align-items-center gap-3">
                ...
                <div class="accreditation-logos d-flex gap-2 align-items-center">
                    ...
                    <img src="../assets/images/nabl-logo.png" alt="NABL Accredited"
                        style="height: 58px; object-fit: contain;">
                </div>
            </div>
                        ...
                        <li class="nav-item dropdown mega-menu-wrapper">
                            ...
                            <div class="dropdown-menu mega-menu">
                                <div class="mega-menu-content">
                                    <!-- Column 1: Centres of Excellence -->
                                        ...
                                        <ul class="mega-menu-list">
                                            ...
                                            <li>
                                                <a href="gastroenterology.php" class="mega-menu-item">
                                                    <img src="../assets/images/liver.webp" alt="Liver"
                                                        style="width: 20px;">
                                            ...
                                            <li>
                                                <a href="nephrology-dialysis.php" class="mega-menu-item">
                                                    <img src="../assets/images/RENAL.webp" alt="Renal Sciences"
                                                        style="width: 20px;">
                                    ...
                                    <div class="mega-menu-column">
                                        ...
                                        <ul class="mega-menu-list">
                                            ...
                                            <li><a href="ent.php" class="mega-menu-item"><i
                                                        ...
                                                        Throat)</span></a></li>
                                            <li><a href="dermatology.php" class="mega-menu-item"><img
                                                        src="../assets/images/DERMA.webp" alt="Dermatology"
                                                        style="width: 20px;"> <span>Dermatology</span></a>
                                            </li>
                                            <li><a href="plastic-surgery.php" class="mega-menu-item"><img
                                                        src="../assets/images/PLASTIC.webp" alt="Plastic Surgery"
                                                        style="width: 20px;"><span>Plastic Surgery</span></a>
                                            </li>
                                            ...
                                            <li><a href="oral-maxillofacial-surgery.php" class="mega-menu-item"><i
                                                        class="fas fa-head-side-mask"></i> <span>Oral & Maxillofacial
                                                        Surgery</span></a>
                                            </li>
                                            <li><a href="neonatology.php" class="mega-menu-item"><i
                                                        class="fas fa-baby"></i> <span>Neonatology</span></a>
                                            </li>
                                            <li><a href="urology-urodynamics.php" class="mega-menu-item"><img
                                                        src="../assets/images/UROLOGY.webp" alt="Urology"
                                                        style="width: 20px;"><span>Urology</span></a>
                                            </li>
                                        </ul>
                                    </div>

                                    <!-- Column 3: Diagnostics & Support -->
                                    <div class="mega-menu-column">
                                        ...
                                        <ul class="mega-menu-list">
                                            ...
                                            <li><a href="radiology.php" class="mega-menu-item"><i
                                                        ...
                                                        Imaging</span></a></li>
                                            <li><a href="emg-ep.php" class="mega-menu-item"><img
                                                        src="../assets/images/EMG_EP.webp" alt="EMG/EP"
                                                        style="width: 20px;"><span>EMG/EP (Nerve & Muscle)</span></a>
                                            </li>
            ...
            <!-- Mobile Toggle -->
            <button class="mobile-toggle d-lg-none" type="button" data-bs-toggle="collapse" data-bs-target="#mobileNav">
        ...
        <div class="collapse mobile-nav" id="mobileNav">
            <ul class="mobile-menu">
                ...
                <li>
                    <a href="#mobileSpecialities" data-bs-toggle="collapse" role="button" aria-expanded="false"
                        aria-controls="mobileSpecialities">
                        Specialities
                    </a>
                    <div class="collapse mobile-submenu" id="mobileSpecialities">
                ...
                <li>
                    <a href="#mobilePatientGuide" data-bs-toggle="collapse" role="button" aria-expanded="false"
                        aria-controls="mobilePatientGuide">
                        Patient Guide
                    </a>
