...
$doctor_id = 'dr-soni-singh'; // ID in doctors-data.php
...
<head>
    ...
    <title>Dr. Soni Singh – Eye Specialist in Noida | Prayag Hospital</title>
    <meta name="description" content="Consult Dr. Soni Singh, Eye Specialist at Prayag Hospital, Noida with 19 years' experience. Book an appointment online or call 0120-4021900.">
    <meta name="keywords" content="eye specialist in noida">
    ...
    <script type="application/ld+json">
{
    ...
    "url": "https://prayaghospital.in/dr-soni-singh.php",
    "worksFor": {
        "@type": "Hospital",
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="doctor-profile-header">
                        ...
                        <p class="lead-text">
                            Dr. Soni Singh is a highly experienced and renowned Senior Consultant Ophthalmologist known for providing advanced and compassionate eye care.
                        </p>
                        <p>
                            He specializes in the diagnosis and treatment of various eye disorders and is highly skilled in performing cataract surgeries, glaucoma management, and retinal disorder treatment. With patient focused care and modern techniques, he ensures the best possible visual outcomes for all age groups.
                        </p>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="content-section">
                        ...
                        <div class="education-timeline">
                            ...
                            <div class="education-item">
                                ...
                                <div class="education-content">
                                    <h4>Diploma in Ophthalmology</h4>
                    ...
                    <div class="content-section">
                        ...
                        <div class="expertise-grid">
                            <div class="expertise-card">
                                ...
                                <p>Phacoemulsification & Micro-Incision</p>
                            </div>
                            <div class="expertise-card">
                    ...
                    <div class="content-section">
                        ...
                        <ul class="specialization-list">
                            <li><i class="fas fa-check-circle"></i> Cataract Surgery (Phacoemulsification & Micro-Incision Cataract Surgery)</li>
                            <li><i class="fas fa-check-circle"></i> Glaucoma Diagnosis and Treatment</li>
                            <li><i class="fas fa-check-circle"></i> Refractive Errors (Spectacles & Contact Lens Management)</li>
                            <li><i class="fas fa-check-circle"></i> Diabetic Retinopathy and Retinal Disorders</li>
                            <li><i class="fas fa-check-circle"></i> Squint (Strabismus) Evaluation & Treatment</li>
                            <li><i class="fas fa-check-circle"></i> Corneal Diseases & Dry Eye Treatment</li>
                            <li><i class="fas fa-check-circle"></i> Eye Infection & Allergy Management</li>
                            <li><i class="fas fa-check-circle"></i> Pediatric Eye Care</li>
                            <li><i class="fas fa-check-circle"></i> Computer Vision Syndrome and Eye Strain Treatment</li>
                            <li><i class="fas fa-check-circle"></i> Minor Eye Trauma and Emergency Eye Care</li>
                        </ul>
                    </div>
