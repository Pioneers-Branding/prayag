...
$doctor_id = 'dr-sunil-kumar-sharma'; // Example: Change to match the doctor's ID
...
<head>
    ...
    <title>Dr. Sunil Kumar Sharma – Orthopedic Surgeon in Noida | Prayag Hospital</title>
    <meta name="description" content="Consult Dr. Sunil Kumar Sharma, Orthopedic Surgeon at Prayag Hospital, Noida with 4 years' experience. Book an appointment online or call 0120-4021900.">
    <meta name="keywords" content="orthopedic surgeon in noida">
    ...
    <script type="application/ld+json">
{
    ...
    "url": "https://prayaghospital.in/dr-sunil-kumar-sharma.php",
    "worksFor": {
        "@type": "Hospital",
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="doctor-profile-header">
                        ...
                        <p class="lead-text">
                            Dr. Sunil Kumar Sharma is a highly experienced Senior Consultant Orthopedic Surgeon, known for excellence in diagnosing and treating complex bone, joint, and musculoskeletal disorders.
                        </p>
                        <p>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="content-section">
                        ...
                        <div class="expertise-grid">
                            <div class="expertise-card">
                                ...
                                <h4>Knee & Hip Replacement</h4>
                                <p>Knee & Hip Joint Replacement Surgery</p>
                            </div>
                            <div class="expertise-card">
                    ...
                    <div class="content-section">
                        ...
                        <ul class="specialization-list">
                            <li><i class="fas fa-check-circle"></i> Knee & Hip Joint Replacement Surgery</li>
